...
#[test]
fn verify_zkp_maze_proof_succeeds() {
    let vk_fields_json: &str = include_str!("zkp_maze/target/vk_fields.json");
    let proof_bin: &[u8] = include_bytes!("zkp_maze/target/proof");
    let pub_inputs_bin: &[u8] = include_bytes!("zkp_maze/target/public_inputs");
