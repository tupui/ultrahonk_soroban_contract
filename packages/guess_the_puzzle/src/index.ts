...
export interface Client {
   ...
   */
  set_puzzle: ({puzzle}: {puzzle: Buffer}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  verify_puzzle: ({guesser, vk_json, public_inputs, proof_blob}: {guesser: string, vk_json: Buffer, public_inputs: Buffer, proof_blob: Buffer}, options?: MethodOptions) => Promise<AssembledTransaction<Result<boolean>>>
   ...
   */
  add_funds: ({funder, amount}: {funder: string, amount: u64}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  public readonly fromJSON = {
    set_puzzle: this.txFromJSON<null>,
        verify_puzzle: this.txFromJSON<Result<boolean>>,
